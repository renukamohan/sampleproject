...
public class Passcode extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("passhin",""+hindi);
        Log.e("passeng",""+english);
        Log.e("passkan",""+kannada);
        Log.e("passtel",""+telugu);
        Log.e("passtam",""+tamil);
...
//                    show.setText("Show");
        ...
        nothng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editText.getText().length()==0&&editText1.getText().length()==0&&editText2.getText().length()==0&&editText3.getText().length()==0) {
                    Toast.makeText(getApplicationContext(),"Type 4 digit password",Toast.LENGTH_SHORT).show();
                }
                else {
